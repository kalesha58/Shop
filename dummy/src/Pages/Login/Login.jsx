...
function Login() {
  ...
  const handleSubmit = (e) => {
    // e.preventDefault();
    if (data.email===loginUser && data.password === loginPassword) {
      navigate("/");
    } else {
  ...
  return (
    <div>
      <div className="loginParentDiv">
        ...
        <p style={{"fontWeight":"600px"}}>If you Don't have Any Account Then Signup</p>
